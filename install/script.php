	...
	array(
		'fill_data' => array(
			...
			"
				...
				(14, 'links_panel_visible', 'true', 'panel górny z linkami widoczny', 3, 1, :save_time),
				(15, 'search_panel_visible', 'true', 'panel wyszukiwania na stronie widoczny', 3, 1, :save_time),
				(16, 'navbar_panel_visible', 'true', 'górny panel nawigacji widoczny', 3, 1, :save_time),
				(17, 'categories_panel_visible', 'true', 'boczny panel nawigacji widoczny', 3, 1, :save_time),
				(18, 'path_panel_visible', 'true', 'panel ze scieżką strony widoczny', 3, 1, :save_time),
				(19, 'logged_panel_visible', 'true', 'panel z nazwiskiem zalogowanego usera widoczny', 3, 1, :save_time),
				(20, 'options_panel_visible', 'true', 'panel menu kontekstowego widoczny', 3, 1, :save_time),
				(21, 'aside_panel_visible', 'true', 'panel sekcji bocznej strony widoczny', 3, 1, :save_time),
				(22, 'options_panel_border', 'false', 'menu kontekstowe w dedykowanym panelu', 3, 1, :save_time),
				(23, 'articles_pagination_enabled', 'true', 'paginacja artykułów wyświetlanej kategorii włączona', 3, 1, :save_time),
				(24, 'articles_per_page', '4', 'liczba artykułów wyświetlanej kategorii na stronę w paginacji', 1, 1, :save_time),
				(25, 'comments_panel_visible', 'true', 'panel z komentarzami do artykułu widoczny', 3, 1, :save_time),
				(26, 'moderate_comments', 'false', 'wymagane moderowanie komentarzy - widoczne po akceptacji', 3, 1, :save_time),
				(27, 'display_list_rows', '20', 'liczba wierszy listy na jednej stronie', 1, 1, :save_time),
				(28, 'description_length', '50', 'maksymalna długość opisu pozycji na liście znalezionych', 1, 1, :save_time),
				(29, 'page_pointer_band', '4', 'liczebność (połowa) paska ze wskaźnikami stron w pasku nawigacji', 1, 1, :save_time),
				(30, 'send_new_message_report', 'true', 'wysyłanie e-mailem raportów do admina o pojawieniu się nowej wiadomości', 3, 1, :save_time),
				(31, 'email_sender_name', 'Mail Manager', 'nazwa konta e-mailowego serwisu', 1, 1, :save_time),
				(32, 'email_host', 'mail.mvc.net.pl', 'host wysyłania maili', 1, 1, '2016-03-30 15:36:02'),
				(33, 'email_port', '587', 'port smtp', 1, 1, '2016-03-30 15:37:03'),
				(34, 'email_password', 'Kns6hT42WkbM', 'hasło konta mailingowego', 1, 1, '2016-03-30 15:40:37'),
				(35, 'email_sender_address', :email_sender_address, 'adres konta e-mailowego serwisu', 1, 1, :save_time),
				(36, 'email_admin_address', :email_admin_address, 'adres e-mail administratora serwisu', 1, 1, :save_time),
				(37, 'email_report_address', :email_report_address, 'adres e-mail odbiorcy raportów', 1, 1, :save_time),
				(38, 'email_report_subject', 'Raport serwisu', 'temat maila raportującego zdarzenie', 1, 1, :save_time),
				(39, 'email_report_body_1', 'Raport o zdarzeniu w serwisie', 'treść maila rapotującego - część przed zmiennymi', 2, 1, :save_time),
				(40, 'email_report_body_2', '(brak)', 'treść maila rapotującego - część za zmiennymi', 2, 1, :save_time),
				(41, 'email_register_subject', 'Rejestracja w serwisie', 'temat generowanego maila przy rejestracji konta', 1, 1, :save_time),
				(42, 'email_register_body_1', 'Informujemy, że Twoje konto w serwisie zostało poprawnie zarejestrowane. Zostałeś zarejestrowany jako:', 'treść generowanego maila po rejestracji - przed parametrami', 2, 1, :save_time),
				(43, 'email_register_body_2', 'Jako zarejestrowany użytkownik możesz pisać komentarze do artykułów i nimi zarządzać.', 'treść generowanego maila po rejestracji - za parametrami', 2, 1, :save_time),
				(44, 'email_remindpwd_subject', 'Nowe hasło do konta', 'temat generowanego maila z nowym hasłem', 1, 1, :save_time),
				(45, 'email_remindpwd_body_1', 'Na Twoją prośbę przesyłamy Ci nowe hasło logowania.', 'treść generowanego maila z nowym hasłem - przed hasłem', 2, 1, :save_time),
				(46, 'email_remindpwd_body_2', 'Zaloguj się, a następnie zmień hasło na swoje własne.', 'treść generowanego maila z nowym hasłem - za hasłem', 2, 1, :save_time);
			",
			"
				...
				(3, 0, 0, 0, 'Regulamin serwisu', 'Regulamin serwisu.', 'Regulamin serwisu', 1, 1, :save_time, 0),
				(4, 0, 0, 0, 'Polityka plików cookies', 'Polityka plików cookies.', 'Polityka plików cookies.', 1, 1, :save_time, 0);
			",
			"
