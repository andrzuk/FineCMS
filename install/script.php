	...
	array(
		'fill_data' => array(
			...
			"
				...
				(19, 'articles_per_page', '4', 'liczba artykułów wyświetlanej kategorii na stronę w paginacji', 1, 1, :save_time),
				(20, 'comments_panel_visible', 'true', 'panel z komentarzami do artykułu widoczny', 3, 1, :save_time),
				(21, 'moderate_comments', 'false', 'wymagane moderowanie komentarzy - widoczne po akceptacji', 3, 1, :save_time),
				(22, 'display_list_rows', '20', 'liczba wierszy listy na jednej stronie', 1, 1, :save_time),
				(23, 'description_length', '50', 'maksymalna długość opisu pozycji na liście znalezionych', 1, 1, :save_time),
				(24, 'page_pointer_band', '4', 'liczebność (połowa) paska ze wskaźnikami stron w pasku nawigacji', 1, 1, :save_time),
				(25, 'send_new_message_report', 'true', 'wysyłanie e-mailem raportów do admina o pojawieniu się nowej wiadomości', 3, 1, :save_time),
				(26, 'email_sender_name', 'Mail Manager', 'nazwa konta e-mailowego serwisu', 1, 1, :save_time),
				(27, 'email_host', 'mail.mvc.net.pl', 'host wysyłania maili', 1, 1, '2016-03-30 15:36:02'),
				(28, 'email_port', '587', 'port smtp', 1, 1, '2016-03-30 15:37:03'),
				(29, 'email_password', 'Kns6hT42WkbM', 'hasło konta mailingowego', 1, 1, '2016-03-30 15:40:37'),
				(30, 'email_sender_address', :email_sender_address, 'adres konta e-mailowego serwisu', 1, 1, :save_time),
				(31, 'email_admin_address', :email_admin_address, 'adres e-mail administratora serwisu', 1, 1, :save_time),
				(32, 'email_report_address', :email_report_address, 'adres e-mail odbiorcy raportów', 1, 1, :save_time),
